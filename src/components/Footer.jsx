      ...
      <footer className="footer flex flex-col gap-5 bg-orange-700 text-white p-10 bg-primary text-primary-content ">
        <div className="flex flex-col items-center justify-center ">
          ...
          <p className="font-bold text-center">
            PE Teknoloji Sanayi ve Ticaret Limited Şirketi <br />
            2021'den beri güvenilir Yazılım ve Robotik Sistemleri güvenle sağlamaktayız.
          </p>
          <p>Copyright © 2023 - All right reserved</p>
        </div>
        <div>
          <div className="grid grid-flow-col gap-10 place-content-center">
            <a href="https://instagram.com/pe_teknoloji" className="hover:text-red-300">
              <svg
